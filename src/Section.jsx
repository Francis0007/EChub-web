        ...
        <div className="section">
          <div className="sectioncontent">
            ...
            <div className="sectioncontent2">
              <h2>Tap into a pool of skilled, vetted, tested and qualified technical talents for your </h2>
            ...
            <div className="textonbottomofhomescreen">
              ...
              <a href="waitinglist.html"><div className="textonbottomofhomescreen1">
                  ...
                  <div className="message"><img src={onk1}height="39.75757598876953px;" width="32px;" left="316px;" top="512.121337890625px;" border-radius="0px;" style={{position: 'fixed', marginLeft: '16px', marginTop: '13px'}} /></div>
                </div></a></div></div></div>
        {/*end of section*/}
</>
  )
