export const Data = [
    ...
    {
        question: 'How can I trust the quality of your artisans?',
        answer: 'We take pride in our rigorous vetting process. Each artisan is carefully selected based on their qualifications, experience, and track record. We ensure they meet our high standards of professionalism and expertise.'
      },
      {
        question: 'Can I monitor and manage my facilities remotely?',
        answer: 'Absolutely! Our web app allows you to conveniently monitor and manage your facilities from anywhere. You can access real-time project reports, repair history, and facility health status, empowering you with valuable insights.'
      },
      {
        question: 'Can I customize a maintenance plan that suits my specific needs?',
        answer: 'Yes, you can subscribe to a customized maintenance plan. We understand that every facility has unique requirements, so we work closely with you to design a plan that aligns with your goals and ensures optimal facility performance.'
      },
      {
